    ...
    const handlePhotoUpload = async (e) => {
        try {
            ...
            const { data: rpcData, error: updateError } = await supabase.rpc('update_my_profile', {
                p_phone: userProfile.phone || '', // Keep existing phone
                p_location: userProfile.location || '', // Keep existing location
                p_avatar_url: publicUrl // Update avatar
            });
        ...
        try {
            ...
            if (profileData) {
                ...
                const fullProfile = {
                    ...profileData,
                    id: profileData.id,
                    email: profileData.email, // Ensure email is available
                    ...
                    department: profileData.department_name // Mapped for UI display
                };
    ...
    const handleSaveProfile = async () => {
        try {
            ...
            const { data, error } = await supabase.rpc('update_my_profile', {
                ...
                p_avatar_url: null // Don't change avatar
            });
