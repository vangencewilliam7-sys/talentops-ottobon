...
const DashboardHome = () => {
    ...
    React.useEffect(() => {
        ...
        fetchDashboardData();
    }, [refreshTrigger, currentProject, orgId]);
                            ...
                            {Array.from({ length: daysInMonth }, (_, i) => i + 1).map(d => {
                                ...
                                return (
                                    <div
                                        ...
                                        onMouseEnter={(e) => {
                                            if (!isSelected) {
                                                e.currentTarget.style.backgroundColor = isHoliday ? '#fed7aa' : '#f1f5f9';
                                            }
                                        }}
                                        onMouseLeave={(e) => {
                                            if (!isSelected) {
                                    ...
                                    >
                                        {d}
                                        {hasOtherEvents && (
                                            <div style={{ position: 'absolute', bottom: '8px', width: '5px', height: '5px', borderRadius: '50%', backgroundColor: isSelected ? '#38bdf8' : isHoliday ? '#ea580c' : '#0ea5e9' }}></div>
                                        )}
                                    </div>
                                );
                            })}
