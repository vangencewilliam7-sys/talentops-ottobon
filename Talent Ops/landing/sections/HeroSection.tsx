                ...
                <div className="relative z-10 w-full max-w-5xl px-6 pt-24 pb-12 md:pt-32 md:pb-16">
                    <div className="flex flex-col items-center gap-6 md:gap-8 text-center">
                        <div className="flex flex-col items-center">
                            <h1 className="reveal-fade font-elegant font-medium text-white text-[clamp(2.5rem,7vw,5rem)] leading-[1.1] flex flex-col items-center">
                            ...
                            <p className="reveal-fade text-lg md:text-xl text-white/90 font-redhat font-normal mt-6 max-w-2xl mx-auto leading-relaxed">
